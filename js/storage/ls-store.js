var LocalStorageStore = function(successCallback, errorCallback) {
    ...
    this.save = function (keyinput, valinput, callback) {
        ...
        //callLater(callback, valinput);
    }

    this.get = function (keyinput, callback) {
        var valoutput = '';
        if(typeof (window.localStorage)!=='undefined'){ 
            valoutput = window.localStorage.getItem(keyinput);
        } 
        else{ 
            throw "window.localStorage, not defined"; 
        }
    ...
    this.remove = function (keyinput, callback) {
        if (typeof (window.localStorage)!=='undefined') {
